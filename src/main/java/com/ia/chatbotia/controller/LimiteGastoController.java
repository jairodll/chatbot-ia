...
import com.ia.chatbotia.Service.Impl.LimiteGastoSvcImpl;
...
public class LimiteGastoController {
    
@Autowired
    LimiteGastoSvcImpl limiteSvc;

    @PostMapping(value = "/save")
    public ResponseEntity<?> saveUsuario(@RequestBody LimiteDto dato) {
        try {
            return ResponseEntity.ok(limiteSvc.guardarLimiteGasto(dato));
